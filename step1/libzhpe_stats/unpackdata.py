...
def printRecord(aRecord):
    print('{},{},{},{},{},{},{},{},{}'.format(aRecord.opflag,aRecord.subid,aRecord.val0,hex(aRecord.val1),hex(aRecord.val2),hex(aRecord.val3),hex(aRecord.val4),hex(aRecord.val5),hex(aRecord.val6)))
